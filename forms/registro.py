...
class RegistroHandler(FormHandler):
    ...
    def process(self, period_or_link: str) -> bool:
        ...
        """
        link = period_or_link
        with AnimatedWaitContext('Retrieving taxpayer data', self.config.is_verbose, self.config.is_debug, self.config.mockup_mode):
        ...
        with AnimatedWaitContext('Retrieving form data', self.config.is_verbose, self.config.is_debug, self.config.mockup_mode):
        ...
        with AnimatedWaitContext('Checking step', self.config.is_verbose, self.config.is_debug, self.config.mockup_mode):
        ...
        with AnimatedWaitContext('Verifying data', self.config.is_verbose, self.config.is_debug, self.config.mockup_mode):
        ...
        # Save data
        with AnimatedWaitContext('Saving tax payer data', self.config.is_verbose, self.config.is_debug, self.config.mockup_mode):
        ...
        with AnimatedWaitContext('Redirecting to document', self.config.is_verbose, self.config.is_debug, self.config.mockup_mode):
        ...
        with AnimatedWaitContext('Confirming document', self.config.is_verbose, self.config.is_debug, self.config.mockup_mode):
        ...
        if final_url:
            with AnimatedWaitContext('Finalizing document', self.config.is_verbose, self.config.is_debug, self.config.mockup_mode):
