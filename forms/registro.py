...
class RegistroHandler(FormHandler):
    ...
    def process(self, period_or_link: str) -> bool:
        ...
        """
        link = period_or_link
        with AnimatedWaitContext('Retrieving taxpayer data', self.config.is_verbose, self.config.is_debug):
        ...
        with AnimatedWaitContext('Retrieving form data', self.config.is_verbose, self.config.is_debug):
        ...
        with AnimatedWaitContext('Checking step', self.config.is_verbose, self.config.is_debug):
        ...
        with AnimatedWaitContext('Verifying data', self.config.is_verbose, self.config.is_debug):
        ...
        # Save data
        with AnimatedWaitContext('Saving tax payer data', self.config.is_verbose, self.config.is_debug):
        ...
        with AnimatedWaitContext('Redirecting to document', self.config.is_verbose, self.config.is_debug):
        ...
        with AnimatedWaitContext('Confirming document', self.config.is_verbose, self.config.is_debug):
        ...
        if final_url:
            with AnimatedWaitContext('Finalizing document', self.config.is_verbose, self.config.is_debug):
